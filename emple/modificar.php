...
<head>
    ...
    <title>Modificar un nuevo empleado</title>
</head>
<body>
    <?php
    ...
    if ($existen) {
        ...
        if ($emp_no == '') {
            ...
            if (!ctype_digit($emp_no)) {
                ...
                if ($emp_no > 9999) {
                    ...
                    if (existe_emp_no_otra_fila($emp_no, $id, $pdo)) {
        ...
        $emp_no_fmt = $fila['emp_no'];
        $apellidos_fmt = $fila['apellidos'];
        $salario_fmt = $fila['salario'];
        $comision_fmt = $fila['comision'];
        $fecha_alt_fmt = $fila['fecha_alt'];
        $oficio_fmt = $fila['oficio'];
        $jefe_id = $fila['jefe_id'];
        $depart_id = $fila['depart_id'];
    }
    ?>
